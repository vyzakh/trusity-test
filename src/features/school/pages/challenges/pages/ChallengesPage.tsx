...
import { students } from "@/core/utils/dummyData";
    ...
    >
      ...
      >
        {students?.map((student) => (
          <TableRow key={student?.id} className={twMerge(DEFAULT_ROW_STYLES)}>
            <TableCell>{student?.id}</TableCell>
            <TableCell className="p-0">
              <Image className="size-8" radius="none" src="/school-logo.png" />
            </TableCell>
            ...
            <TableCell className="text-center">{student.challenges}</TableCell>
            <TableCell className="text-center">{student.inprogress}</TableCell>
            <TableCell className="text-center">{student.completed}</TableCell>
            ...
            <TableCell className="text-center">
              <div className="flex items-center justify-center">
                ...
                <Button
                  as={Link}
                  className="h-min w-min min-w-min px-2 py-2 group-hover:bg-transparent group-hover:text-[#4F78FB]"
                  size="sm"
                  // to={school?.id}
                  variant="light"
                >
...
export const TopContent = () => {
  return (
    <div className="flex items-center gap-4">
      ...
      <Input
        className="ml-auto min-w-44 max-w-sm"
        classNames={{
          inputWrapper:
