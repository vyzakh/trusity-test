...
import type { StudentsQueryResponse } from "../services/types";
...
export default function StudentsPage() {
  ...
  const { data: students = { students: [] }, loading } = useQuery<
    StudentsQueryResponse,
    PaginationInput
  >(STUDENTS_QUERY, { variables: { limit, offset } });
...
export const TopContent = () => {
  return (
    <div className="flex items-center gap-4">
      ...
      <Input
        className="ms-auto max-w-sm min-w-44"
        classNames={{
          inputWrapper:
